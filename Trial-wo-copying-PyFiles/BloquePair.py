...
for m1 in range(0,ThetaBins): 
    ...
    for m2 in range(0,ThetaBins):
        ...
        if mm1==mm2:
            ...
            Ham = 0.#float(Momentum(mm1,nTan) + HartreeFock(Momentum(mm1,nTan)) - HartreeFockCutOff(Momentum(mm1,nTan)))
            ...
            #Ham[m1,m2] = 0
        file1.write("%s" % (5*ThetaBins + mm1 - 1)),
        file1.write("\t"),
        file1.write("%s" % (mm2 - 1)),
        file1.write("\t"),
        file1.write("%s" % (Ham))
